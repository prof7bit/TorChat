...
class function TMsgFileStopReceiving.ReceiveOnOutgoing: Boolean;
begin
  Result := True;
end;
...
procedure TMsgFileStopReceiving.ExecuteWithBuddy;
var
  Transfer: IFileTransfer;
begin
  Transfer := FClient.FindFileTransferRecv(FTransferID);
